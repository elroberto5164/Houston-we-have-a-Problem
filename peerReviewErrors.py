...
def displayIntro():
	...
	is greedy and hungry, and will eat you on sight.''')#um...normal quotations would have worked fine here me thinks.These triple quotes are more for a definition of what the function does.
	print()#Heh?
...
def checkCave(chosenCave):#This doesn't feel right...right? shouldn't this be (chooseCave)? 
	...
	#sleep for 2 seconds
	time.sleep(3)#In reference to comment on line 37, what's this then?
...
playAgain = 'yes' #Does this belong here? Also shouldn't there be parentheses here?
while playAgain = 'yes' or playAgain = 'y':#Need another equal sign after playAgain, both times, to actuate the while loop.
	...
	caveNumber = choosecave() #See line 46 comment
	checkCave(caveNumber) #See line 46 comment
	...
	if playAgain == "no": #Wait, so if you're going to do this, wouldn't you need a break line thingy to break the while loop, to get to this line?
		...
		#Also, Also, "planing" Don't think we're woodworking here...
